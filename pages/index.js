...
export default function Home() {
  ...
  const [vestors, setVestors] = useState([
    { address: "", type: "founder", whiteListed: false, amount: "" },
  ]);
  ...
  function convertToTimestamp(obj) {
    ...
    const timestamp =
      Number(days) * secondsPerDay +
      Number(hours) * secondsPerHour +
      Number(minutes) * secondsPerMinute;
    return timestamp;
  }
  ...
  return (
    <main className="flex w-full items-center justify-center flex-col flex-wrap">
      ...
      <h1 className="font-bold text-[40px] leading-4 p-[20px] mt-[20px] mb-[40px]">
        Vesting
      </h1>
      <div className="flex w-full flex-col gap-[30px] items-center justify-center border-b-2 py-[20px] border-indigo-500">
        <div className="flex gap-[30px]">
          <button
            className="border-2 rounded-[6px] border-indigo-500 bg-indigo-500 p-[10px] font-semibold"
            onClick={() => {
              setType("stakeholder");
              getOrgs();
            }}
          ...
          (type === "stakeholder" ? (
            orgs != null && orgs[0].length > 0 ? (
              <div className="flex gap-[30px] w-full justify-center items-center">
                ...
                <select
                  className="p-[7px] text-[15px] border-2 border-black outline-none rounded"
                  onChange={(e) => {
                    setWithdrawOrg(e.target.value);
                ...
                <button
                  className="border-2 rounded-[6px] border-sky-600 bg-sky-600 p-[10px] font-semibold m-auto w-full"
                  onClick={withdraw}
                >
                  Withdraw
                </button>
              ...
              <h1 className="text-[20px]">
                No Organisations has registered yet.
              </h1>
            )
            ...
            <div className="flex flex-col items-center justofy-center gap-[30px]">
              ...
              <div className="flex flex-col gap-[20px] items-start justify-start">
                ...
                <span className="text-[20px] font-semibold">
                  Total Supply: {Number(org[2])}
                </span>
                <span className="text-[20px] font-semibold">
                  Vesting time: {getDate(org[6])}
                </span>
                  ...
                  <tbody>
                    {org[3].map((el, i) => (
                      ...
                      >
                        ...
                        <td className="p-2 border-2 border-gray-300">
                          {org[7][i] === true ? (
                            <span className="font-bold text-[20px] rounded-[50%] py-[3px] px-[12px] cursor-pointer select-none bg-green-500 text-white">
                              +
                            </span>
                          ) : (
                            <span className="font-bold text-[20px] rounded-[50%] py-[3px] px-[12px] cursor-pointer select-none bg-orange-500 text-white">
                              -
                            </span>
                          )}
                        </td>
            ...
            <div className="w-full flex flex-col flex-wrap gap-[30px] justify-center items-center">
              <button
                className="border-2 rounded-[6p6] border-sky-600 bg-sky-500 p-[10px] font-semibold"
                onClick={() => {
              ...
              {registerClicked === true && (
                <form
                  className="flex flex-col flex-wrap gap-[30px] justify-start items-start"
                  onSubmit={(e) => {
                    e.preventDefault();
                    registerOrg();
                  }}
                >
                      ...
                      >
                        ...
                        <div className="flex gap-[5px] items-center justify-center">
                          <input
                            ...
                            id={`whitelist${i}`}
                            onChange={(e) => {
                              changeVestors(e, i, "whiteListed");
                            }}
                            className="p-[7px] text-[20px] w-[25px] h-[25px] border-2 border-black outline-none rounded"
                            checked={el.whiteListed}
                          />
                        ...
                        <input
                          ...
                          required
                          onChange={(e) => {
                            changeVestors(e, i, "amount");
                          }}
                          placeholder="Vested Amount"
                        />
                        <span
                          className="font-bold text-[20px] rounded-[50%] py-[3px] px-[12px] cursor-pointer select-none bg-slate-500"
                          onClick={() => {
                            setVestors([
                              ...vestors,
                              {
                  ...
                  <button
                    type="submit"
                    className="border-2 rounded-[6px] border-sky-500 bg-sky-500 p-[10px] font-semibold m-auto w-full"
                  >
                    Register
                  </button>
                </form>
